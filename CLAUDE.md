...
- `server/astroEngine/*` — native TS astrology engine (kundli, dasha, horoscope, **panchang**). `server/agents/*` — AI "Super-Astrologer Council" (`runCouncil`) used by the AI astrologer. `astro-engine-rs/` — Rust engine (shadbala/yoga).
